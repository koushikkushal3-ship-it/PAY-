...
const d = report.by_difficulty;
console.log('');
console.log('By case difficulty (ambiguous archetypes are designed to conflict):');
console.log(`  ambiguous   ${d.ambiguous.correct}/${d.ambiguous.cases} correct, mean confidence ${pct(d.ambiguous.mean_confidence)}`);
console.log(`  clear cut   ${d.clear_cut.correct}/${d.clear_cut.cases} correct, mean confidence ${pct(d.clear_cut.mean_confidence)}`);
console.log('');
